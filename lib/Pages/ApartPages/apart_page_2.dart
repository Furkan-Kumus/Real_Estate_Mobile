...
class ApartPage2 extends StatefulWidget {
  const ApartPage2({super.key});

  @override
  State<ApartPage2> createState() => _ApartPageState();
}

class _ApartPageState extends State<ApartPage2> {
  @override
    ...
    return Scaffold(
      body: SingleChildScrollView(
        ...
        child: Stack(
          children: <Widget>[
            Container(
              child: Image.asset("images/house_1_5/h2_full.jpg", fit: BoxFit.cover,),

...
class ApartPage4 extends StatefulWidget {
  const ApartPage4({super.key});

  @override
  State<ApartPage4> createState() => _ApartPageState();
}

class _ApartPageState extends State<ApartPage4> {
  @override
    ...
    return Scaffold(
      body: SingleChildScrollView(
        ...
        child: Stack(
          children: <Widget>[
            Container(
              child: Image.asset("images/house_1_5/h4_full.jpg", fit: BoxFit.cover,),

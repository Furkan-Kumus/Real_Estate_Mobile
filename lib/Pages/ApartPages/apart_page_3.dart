...
class ApartPage3 extends StatefulWidget {
  const ApartPage3({super.key});

  @override
  State<ApartPage3> createState() => _ApartPageState();
}

class _ApartPageState extends State<ApartPage3> {
  @override
    ...
    return Scaffold(
      body: SingleChildScrollView(
        ...
        child: Stack(
          children: <Widget>[
            Container(
              child: Image.asset("images/house_1_5/h3_full.jpg", fit: BoxFit.cover,),
